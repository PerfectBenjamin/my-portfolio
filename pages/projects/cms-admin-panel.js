...
const screenshots = [
  { src: "/images/projects/cms-panel/CMS1.png", alt: "Dashboard" },
  { src: "/images/projects/cms-panel/CMS2.png", alt: "Members" },
  { src: "/images/projects/cms-panel/CMS3.png", alt: "Contributions" },
  { src: "/images/projects/cms-panel/CMS4.png", alt: "Loans" },
  { src: "/images/projects/cms-panel/CMS5.png", alt: "Purchase Requests" },
];

const tech = ["React.js", "Firebase", "Tailwind CSS"];
...
export default function CmsAdminPanel() {
  ...
  return (
    <>
      <Head>
        <title>CMS Admin Panel - Perfect Benjamin-Maji</title>
              ...
              <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[48%] lg:flex-col lg:justify-between lg:py-24">
                <div>
                  ...
                  <h2 className="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">
                    Case Study of Nile University of Nigeria
                  </h2>
                  <p className="mt-4 max-w-xs leading-normal">
                    A comprehensive cooperative management system admin panel
                    with user authentication, payment processing, and admin
                    dashboard. Features real-time inventory management and
                    analytics.
                  </p>
                ...
                <div className="flex flex-col gap-6">
                  {screenshots.map((s) => (
                    <div key={s.src} className="group relative">
                      ...
                      />
                      <p className="mt-2 text-xs text-slate-500">{s.alt}</p>
                    </div>
                  ))}
                </div>
              </main>
